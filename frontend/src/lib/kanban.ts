...
// The id of the column that holds `id`, where `id` is either a column id or a
// card id. Undefined if not found.
export const columnIdForItem = (
  columns: Column[],
  id: string
): string | undefined => {
...
// Move a card into a target column at a given index, removing it from wherever
// it currently is. Used for live cross-column movement during a drag.
export const placeCardInColumn = (
  columns: Column[],
  cardId: string,
  toColumnId: string,
  index: number
